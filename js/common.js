...
com.bylaw.j = function (x,y,map,my){
	...
	if (my===1){ //Quân đỏ
		...
		//trên
		if ( y-1>= 5 && (!com.mans[map[y-1][x]] || com.mans[map[y-1][x]].my!=my)) d.push([x,y-1]);
         // Tình huống 2 tướng đối đầu
		if ( com.mans["j0"].x == com.mans["J0"].x && isNull) d.push([com.mans["J0"].x,com.mans["J0"].y]);
		
	}else{
		//dưới
		if ( y+1<= 4  && (!com.mans[map[y+1][x]] || com.mans[map[y+1][x]].my!=my)) d.push([x,y+1]);
		//trên
...
com.value = {
	...
	p:[
		...
		[150, 150, 146,141, 140,141, 146, 150, 150],
		[148, 148, 146,142, 149,142, 146, 148, 148],
		[147, 147, 146,141, 142,141, 146, 147, 147],
		[146, 149, 149,148, 150,148, 149, 149, 146],
		[146, 146, 146,146, 150,146, 146, 146, 146], 
		
		[145, 146, 149,146, 150,146, 149, 146, 145],
		[146, 146, 146,146, 146,146, 146, 146, 146],
		[147, 146, 150,149, 151,149, 150, 146, 147],
		[146, 147, 148,148, 148,148, 148, 147, 146],
		[146, 146, 147,149, 149,149, 147, 146, 146]
	],
